...
export function LogoIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ThumbUpIcon({ className = '', size = 16 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M14 2l-3 7v13h9a2 2 0 0 0 2-1.7l1.4-9A2 2 0 0 0 21.4 9H15" />
    </svg>
  );
}
...
export function ThumbDownIcon({ className = '', size = 16 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M10 22l3-7V2H4a2 2 0 0 0-2 1.7L.6 12.7A2 2 0 0 0 2.6 15H9" />
    </svg>
  );
}
...
export function DnaIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WaveformIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PaletteIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
